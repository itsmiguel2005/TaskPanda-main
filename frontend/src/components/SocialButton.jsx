export default function SocialButton({ provider }) {
  ...
  const baseClasses = "inline-flex items-center justify-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition-colors focus:outline-none focus:ring-2 ";
  const variantClasses = isFacebook
    ? "bg-[#1877F2] text-white border-[#1877F2] hover:bg-[#1565D8] focus:ring-[#1877F2]/30"
    : "bg-[#f5f5f5] text-gray-800 border-gray-200 hover:bg-gray-100 focus:ring-gray-500/30";
  return (
    <button
      type="button"
